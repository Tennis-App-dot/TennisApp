...
public static class ReservationIdGenerator
{
    ...
    /// <returns>New reservation ID (10 digits) with sequence starting from 01</returns>
    public static string GeneratePaidReservationId(DateTime requestDate)
    {
        // Format: YYYYMMDD
        string datePrefix = requestDate.ToString("yyyyMMdd");
        
        // Use random sequence or timestamp-based sequence for temporary ID
        // This will be validated/regenerated by the backend if needed
        var random = new Random();
        int sequence = random.Next(1, 100); // 01-99
