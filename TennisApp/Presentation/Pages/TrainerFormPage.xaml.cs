...
public sealed partial class TrainerFormPage : Page
{
    ...
    {
        System.Diagnostics.Debug.WriteLine("TrainerFormPage: Save button clicked");
        ...
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Creating trainer: {newTrainer.FullName} (ID: {newTrainer.TrainerId})");
            ...
            if (success)
            {
                System.Diagnostics.Debug.WriteLine("✅ Trainer saved successfully");
            ...
            {
                System.Diagnostics.Debug.WriteLine("❌ Failed to save trainer");
                await ShowErrorDialog("เกิดข้อผิดพลาดในการบันทึกข้อมูล");
            }
        }
        catch (Exception ex)
        {
            System.Diagnostics.Debug.WriteLine($"❌ Error saving trainer: {ex.Message}");
